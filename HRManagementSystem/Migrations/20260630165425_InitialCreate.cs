        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KpiCategoryId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PerformanceDetails_KpiCategories_KpiCategoryId",
                        column: x => x.KpiCategoryId,
                        principalTable: "KpiCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PerformanceDetails_PerformanceReviews_PerformanceReviewId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Độ chính xác và hiệu quả của kết quả đầu ra", "Chất lượng công việc", 40 },
                    { 2, "Khả năng hoàn thành đúng thời hạn (Deadline)", "Tiến độ công việc", 30 },
                    { 3, "Chấp hành nội quy và tinh thần phối hợp", "Thái độ & Kỷ luật", 20 },
                    { 4, "Giao tiếp, làm việc nhóm, giải quyết vấn đề", "Kỹ năng mềm", 10 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerformanceDetails_KpiCategoryId",
                table: "PerformanceDetails",
                column: "KpiCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_PerformanceDetails_PerformanceReviewId",
                table: "PerformanceDetails",
